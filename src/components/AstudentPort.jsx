      ...
      <form className="bg-white p-5 w-full md:w-72 rounded shadow-md" onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <label className="inline-flex items-center">
            ...
            />
            <span className={lunch ? "ml-2 text-green-800" : "ml-2 text-red-600"}  > {lunch ? 'Lunch is On' : 'Lunch is Off'}</span>
          </label>
        </div>
        <div className="mb-6">
          <label className="block text-gray-700 text-sm font-bold mb-2">Breakfast</label>
          <label className="inline-flex items-center">
            <input
              type="checkbox"
              className="form-checkbox h-5 w-5 text-blue-500"
            ...
            />
            <span className={breakfast ? "ml-2 text-green-800" : "ml-2 text-red-600"}  > {breakfast ? 'Breakfast is On' : 'Breakfast is Off'}</span>
          </label>
        </div>
        {/* More Options Button */}
        <div className="mb-4">
        ...
        {/* Checkout Options - Hidden by default */}
        {showCheckoutOptions && (
          <div className="mb-4">
